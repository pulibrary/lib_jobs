...
export default {
  ...
  methods: {
    ...
    searchResources: async function ({ eadId }) {
      ...
      try {
        response = await fetch(`/absolute-ids/repositories/${this.repository}/resources/search`, {
          method: 'POST',
          mode: 'cors',
          cache: 'no-cache',
    ...
    searchContainers: async function ({ indicator, callNumber }) {
      const payload = {
        indicator,
        callNumber
      };
      ...
      try {
        response = await fetch(`/absolute-ids/repositories/${this.repository}/containers/search`, {
          method: 'POST',
          mode: 'cors',
          cache: 'no-cache',
          credentials: 'same-origin',
