...
module Aspace2alma
  ...
  class SendMarcxmlToAlmaJob < LibJob
    ...
    def process_resource(resource, file, log_out, barcode_duplicate_check)
      ...
      file << doc.at_xpath('//marc:record') unless tag099_a.content =~ /^(C0140|C1771|AC214|AC364|C0744.06|C0935|C1296|WC059|RBD1|RBD1.1|C0723.1-47|LAE\d+|SPA\d+|POR\d+)$/ || tag856.nil?
      file.flush
      log_out.flush
