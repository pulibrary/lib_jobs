...
module Oclc
  class NewlyCatalogedJobAll < LibJob
    ...
    def self.csv_file_path
      Rails.application.config.newly_cataloged.selector_csv_path
    end
    ...
    def create_csv_with_all_generally_relevant_records
      Dir.mkdir(NewlyCatalogedJobAll.csv_file_path) unless Dir.exist?(NewlyCatalogedJobAll.csv_file_path)
      create
    end
    ...
    def create
      ...
      CSV.open(NewlyCatalogedJobAll.all_records_file_path, 'w', encoding: 'bom|utf-8') do |csv|
