...
RSpec.describe Oclc::Record, type: :model do
  ...
  context 'with a newer fixture' do
    ...
    context 'with relevant record 1' do
      ...
      # xit 'can go through all the records to find a relevant one' do
      ...
      #     byebug if record['001'].value.strip == 'on1390709398'
      #   end
      # end
    end
  ...
  context 'with an older fixture' do
