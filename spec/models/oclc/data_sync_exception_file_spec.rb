...
RSpec.describe Oclc::DataSyncExceptionFile, type: :model do
  ...
  let(:new_file_for_alma_path_1) { 'spec/fixtures/oclc/exceptions/datasync_errors_20230713_103005835_1.mrc' }
  let(:new_file_for_alma_path_2) { 'spec/fixtures/oclc/exceptions/datasync_errors_20230713_103005835_2.mrc' }
