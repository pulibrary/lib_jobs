...
RSpec.describe AirTableStaff::CSVBuilder do
  ...
  it 'creates a CSV object with data from the HTTP API' do
    expected = <<~END_CSV
            puid,netid,phone,name,lastName,firstName,email,address,building,department,division,unit,team,mySchedulerLink,areasOfStudy
            123,ab123,(123) 123-1234,Phillip Librarian,Librarian,Phillip,ab123@princeton.edu,123 Stokes,Stokes,Stokes,,,,https://example.com,Virtual Reality
        END_CSV
