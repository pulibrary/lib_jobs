...
RSpec.describe WebStaff::StaffDirectoryGenerator, type: :model do
  ...
  let(:user1_line) { "90009\tLibrary Test Department\tLibrary Test Department Long\tPUHRS\t999999999\tI\tam\tTest\tTester\ttesti\tBiw\tR=BenElig\t000000000\tLibrary Office Assistant I\tLibrary Office Assistant One\tManager, I Am.\timanager\t000000001\tFirestone Library\t123 Library Information Technology Way\t \tPrinceton\tNJ\t08544\tUSA\t609/258-2222\ttesti@Princeton.EDU" }
  let(:user2_line) { "90009\tTest Department\tTest Department Long\tPUHRS\t999999998\tII\tam\tTest\tTesti\ttestii\tBiw\tR=BenElig\t000000000\tLibrary Office Assistant II\tLibrary Office Assistant Two\tManager, I Am.\timanager\t000000001\tFirestone Library\t123 Library Information Technology Way\t \tPrinceton\tNJ\t08544\tUSA\t609/258-2223\ttestii@Princeton.EDU" }
  let(:user3_line) { "90009\tTest Department\tTest Department Long\tPUHRS\t999999997\tIII\tam\tTest\tTestii\ttestiii\tBiw\tR=BenElig\t000000000\tLibrary Office Assistant III\tLibrary Office Assistant Three\tManager, I Am.\timanager\t000000001\tFirestone Library\t123 Library Information Technology Way\t \tPrinceton\tNJ\t08544\tUSA\t609/258-2224\ttestiii@Princeton.EDU" }
  ...
  let(:report_line3) { '"999999997","testiii","(609) 258-2224","Test, Testii","Test","III","am","Testii","Library Office Assistant III","Library Office Assistant Three","Library Office Assistant Three","testiii@princeton.edu",,,"Test Department Long",,,,,,,,0,,"123 Library Information Technology Way","Firestone Library"' }
  let(:report_line4) { '"999999996","testiv","(609) 258-2225","Test, Testiii","Test","III","am","Testiii","Library Office Assistant IV","Library Office Assistant Four","Library Office Assistant Four","testiv@princeton.edu",,,"Test Department Long",,,,,,,,0,,"123 Library Information Technology Way","Firestone Library"' }
  # rubocop:enable Layout/LineLength
