...
RSpec.describe WebStaff::HrStaffReport, type: :model do
  ...
  let(:user_line) { "90009\tTest Department\tTest Department Long\tPUHRS\t99999999\tI\tam\tTest\ttesti\tBiw\tR=BenElig\t000000000\tLibrary Office Assistant II\t\tManager, I Am.\timanager\t000000001\tFirestone Library\tLibrary Information Technology\t \tPrinceton\tNJ\t08544\tUSA\t732/111-2222\ttesti@Princeton.EDU" }
  ...
  let(:result_hash) do
    { "Department Number" => "90009", "Manager" => "Manager, I Am.", "Bsns Unit" => "PUHRS", "Department Name" => "Test Department", "EID" => "99999999", "First Name" => "I",
      ...
      "Department Long Name" => "Test Department Long", "Register Title" => nil }
  end
