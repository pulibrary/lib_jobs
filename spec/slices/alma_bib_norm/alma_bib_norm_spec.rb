...
RSpec.describe AlmaBibNorm::AlmaBibNorm do
  ...
  describe "submit job to Alma API" do
    context "with a successful response" do
      before do
        stub_request(:post, "https://api-na.hosted.exlibrisgroup.com/almaws/v1/conf/jobs/M7407373650006421?apikey=1234&op=run")
