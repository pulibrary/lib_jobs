...
RSpec.describe AirTableStaff::CSVBuilder do
  ...
  it 'creates a CSV string with data from the HTTP API' do
    ...
    expected = <<~END_CSV
            puid,netid,phone,name,lastName,firstName,email,address,building,department,division,unit,team,title,areasOfStudy,websiteUrl,bios,expertise,mySchedulerLink,otherEntities,pronouns,optInContactInfo
            ...
            fantastic!",,https://example.com,Industrial Relations//James Madison Program,he/him/his,true
        END_CSV
